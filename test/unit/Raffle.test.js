...
!developmentChains.includes(network.name)
    ...
    : describe("Raffle Unit Tests", function () {
          ...
          beforeEach(async function () {
              ...
              const myVrfCoordinatorV2Mock = await deployments.get("VRFCoordinatorV2Mock")
              vrfCoordinatorV2Mock = await ethers.getContractAt(
                  myVrfCoordinatorV2Mock.abi,
                  myVrfCoordinatorV2Mock.address
              )
          ...
          describe("checkUpkeep", function () {
              it("Returns false if people didn't send any ETH", async function () {
                  await network.provider.send("evm_increaseTime", [interval.toNumber() + 1])
                  await network.provider.send("evm_mine", [])
          ...
          describe("fulfillRandomWords", function () {
              ...
              it("picks a winner, resets the lottery, and send money", async function () {
                  ...
                  //fulfillRandomWords (mock being the Chainlink)
